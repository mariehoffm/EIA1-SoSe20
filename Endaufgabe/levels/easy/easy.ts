...
var sound: string[] =["sounds/sound_boing.mp3.webarchive", "/sounds/sound_boing_2.mp3.webarchive", "sounds/sound_kids_booo.mp3.webarchive", "sounds/sound_laugh.mp3.webarchive"];
