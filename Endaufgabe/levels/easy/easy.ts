...
var song: string [] = [ "/sounds/sound_boing_2.mp3",  "/sounds/sound_laugh.mp3", "/sounds/sound_boing.mp3", "/sounds/sound_laugh.mp3", "/sounds/sound_laugh.mp3"]
...
document.getElementById("button2").addEventListener("click", function () {
    var playsound: HTMLAudioElement = new Audio("/sounds/sound_boing_2.mp3"); 
...
document.getElementById("button3").addEventListener("click", function () {
    ...
    var playsound: HTMLAudioElement = new Audio("/sounds/sound_kids_booo.mp3"); 
    playsound.play();
...
document.getElementById("button4").addEventListener("click", function () {
    ...
    var playsound: HTMLAudioElement = new Audio("/sounds/sound_laugh.mp3"); 
    playsound.play();
...
document.getElementById("button5").addEventListener("click", function () {
    ...
    var playsound: HTMLAudioElement = new Audio("/sounds/sound_squeaking.mp3"); 
    playsound.play();
